    ...
    <header id="header" style="background-color: #F7F8FA"
        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand text-center" href="{{route('admin.dashboard.index')}}" aria-label="">
                    <img class="navbar-brand-logo" style="max-height: 42px;max-width:60px"
                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                         src="{{asset("storage/app/public/company/$e_commerce_logo")}}" alt="Logo">
                    <img class="navbar-brand-logo-mini" style="max-height: 42px;max-width:60px"
                         onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
