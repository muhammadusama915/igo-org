                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="">{{\App\CPU\translate('Chaser')}}</a>
                            </li>
                ...
                <div class="card mt-3">
                    ...
                    <form id="chaser">
                        ...
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Action')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <select name="action" class="form-control chaser-field" required>
                                    <option value="">Select</option>
                                    <option value="10" @if($lead->status == 10) selected @endif>In Progress</option>
                                    <option value="11" @if($lead->status == 11) selected @endif>Approved</option>
                                    <option value="12" @if($lead->status == 12) selected @endif>Rejected</option>
                                </select>
                            </div>
                        <div class="row">
                         <div class="col-md-6">
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Fax Sent')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                                <select name="fax_sent" class="form-control chaser-field form-type" id="" required>
                                    <option value="">Select</option>
                            ...
                            <div class="input-group input-group-sm-down-break">
                            <select name="fax_received" class="form-control chaser-field form-type" id="" required>
                                    <option value="">Select</option>
                            ...
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('FollowUp Remarks')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                               <textarea name="remarks" class="form-control chaser-field" rows="3" placeholder="Please Type your remarks" required>{{ $lead->chaser_details ? $lead->chaser_details->remarks : '' }}</textarea>
                            </div>
                            <hr>
...
@push('script_2')
   <script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('submit','#chaser',function(e){
            e.preventDefault();
            $('.submit-btn').attr('disabled',true);
            $('.form-control').removeClass('is-invalid');
            $('.invalid-feedback.is-invalid').remove();
            $.ajax({
                url : "{{route('admin.chaser.store')}}",
                type : "POST",
                data : new FormData(this),
                dataType : "json",
                contentType : false,
                ...
                success:function(response){
                    ...
                    $('.chaser-field').attr('disabled',true);
                },
                error:function(xhr){
                    erroralert(xhr);
                    $('.submit-btn').attr('disabled',false);
