                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-12 mb-3 border-bottom">
                                    <h5 class="card-header-title float-left mb-2">
                                        ...
                                        {{\App\CPU\translate('Statistics for Leads')}}
                                    </h5>
                                    <!-- Legend Indicators -->
                                ...
                                <div class="col-md-4 col-12 graph-border-1">
                                    ...
                                    <span class="h6 mb-0">
                                        ...
                                        {{\App\CPU\translate('Total Leads')}} : 12
                                    </span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 graph-border-1">
                                    <div class="mt-2 center-div">
                                      <span class="h6 mb-0">
                                         ...
                                         {{\App\CPU\translate('Total Confirmations')}} : 5
                                    </span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12 graph-border-1">
                                    <div class="mt-2 center-div">
                                      <span class="h6 mb-0">
                                        ...
                                        {{\App\CPU\translate('Approved By QA 3')}} : 3
                                    </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            "data": {
                              ...
                              "datasets": [{
                                "data": [1,{{$inhouse_data[2]}},{{$inhouse_data[3]}},{{$inhouse_data[4]}},5,{{$inhouse_data[6]}},{{$inhouse_data[7]}},{{$inhouse_data[8]}},{{$inhouse_data[9]}},{{$inhouse_data[10]}},{{$inhouse_data[11]}},{{$inhouse_data[12]}}],
                                "backgroundColor": "#FFC074",
                                "hoverBackgroundColor": "#FFC074",
                                "borderColor": "#FFC074"
                              },
                              {
                                "data": [{{$seller_data[1]}},{{$seller_data[2]}},4,{{$seller_data[4]}},{{$seller_data[5]}},{{$seller_data[6]}},{{$seller_data[7]}},8,{{$seller_data[9]}},{{$seller_data[10]}},{{$seller_data[11]}},10],
                                "backgroundColor": "#B6C867",
                                "borderColor": "#B6C867"
                              },
                              {
                                "data": [{{$commission_data[1]}},2,{{$commission_data[3]}},{{$commission_data[4]}},{{$commission_data[5]}},{{$commission_data[6]}},{{$commission_data[7]}},{{$commission_data[8]}},9,{{$commission_data[10]}},{{$commission_data[11]}},{{$commission_data[12]}}],
...
<script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            labels: [
                '{{\App\CPU\translate('employees')}} ( {{$data['customer']}} )',
                '{{\App\CPU\translate('customrs')}} ( {{$data['store']}} )',
                '{{\App\CPU\translate('leads')}} ( {{$data['product']}} )',
            ],
            datasets: [{
