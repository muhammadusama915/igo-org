...
@section('title', \App\CPU\translate('Confirmation'))
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="">{{\App\CPU\translate('Confirmation')}}</a>
                            </li>
        ...
        <div class="row" id="printableArea">
            ...
            <div class="col-lg-4">
                    ...
                    <form id="qa2-form">
                        ...
                        <div class="card-body">
                           ...
                           <div class="input-group input-group-sm-down-break mt-2">
                            ...
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Remarks')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                               <textarea name="remarks" class="form-control eligibility-field qa2-field" rows="3" placeholder="Please Type your remarks" disabled>{{ $lead->qa2_details ? $lead->qa2_details->remarks : '' }}</textarea>
                            </div>
                            </form>                    
                        </div>
                <!-- End Body -->
                ...
                <div class="card">
                    <!-- Header -->
                    <div class="card-header">
                        <h4 class="card-header-title">{{\App\CPU\translate('Form Filling Feedback')}}</h4>
                    </div>
                    <!-- End Header -->

                    <!-- Body -->
                    <form id="form-filling">
                        @csrf
                        <input type="hidden" name="lead_id" value="{{$lead->id}}">
                        <input type="hidden" class="form-control" name="agent_id" id="formLabel"
                            placeholder="{{\App\CPU\translate('Name of Agent ')}}" aria-label="Type "
                            value="{{auth('admin')->id()}}">
                        <div class="card-body">
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Assign To')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <select name="assign_to" class="form-control form-filling-field select-2" required>
                                    <option>Select Agent</option>
                                     @foreach($lead->all_agents() as $agent)
                                        <option value="{{$agent->id}}" {{ $lead->form_filling_details ? ($lead->form_filling_details->assign_to == $agent->id ? 'selected' : '') : '' }}>{{$agent->name}}</option>
                                     @endforeach
                                </select>
                            </div>
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Form Type')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                                <select name="type" class="form-control form-type form-filling-field" id="" required>
                                    <option value="">Select</option>
                                    <option value="Universal" {{ $lead->form_filling_details ? ($lead->form_filling_details->type == 'Universal' ? 'selected' : '') : '' }}>Universal</option>
                                    <option value="Custom" {{ $lead->form_filling_details ? ($lead->form_filling_details->type == 'Custom' ? 'selected' : '') : '' }}>Custom</option>
                                </select>
                            </div>
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Dignoses')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            @php
                                $diagnose = $lead->form_filling_details ? json_decode($lead->form_filling_details->diagnose) : []; 
                            @endphp
                            @foreach($diagnose as $item)   
                            <span class="badge badge-soft-danger ml-sm-3">
                                <span class="legend-indicator bg-warning"></span>{{$item}}
                            </span> 
                            @endforeach
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Remarks')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                               <textarea name="remarks" class="form-control form-filling-field" rows="3" placeholder="Please Type your remarks" required>{{ $lead->form_filling_details ? $lead->form_filling_details->remarks : '' }}</textarea>
                            </div>
                            </form>                    
                        </div>
                <!-- End Body -->
                ...
                <div class="card mt-3">
                    <!-- Header -->
                    <div class="card-header">
                        <h4 class="card-header-title">{{\App\CPU\translate('Chaser Feedback')}}</h4>
                    </div>
                    <!-- End Header -->
                    ...
                    <form id="chaser">
                        ...
                        <div class="row">
                         <div class="col-md-6">
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Fax Sent')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                                <select name="fax_sent" class="form-control chaser-field form-type" id="" disabled>
                                    <option value="">Select</option>
                                    <option value="Yes" {{ $lead->chaser_details ? ($lead->chaser_details->fax_sent == 'Yes' ? 'selected' : '') : '' }}>Yes</option>
                                    <option value="No" {{ $lead->chaser_details ? ($lead->chaser_details->fax_sent == 'No' ? 'selected' : '') : '' }}>No</option>
                                </select>
                            </div>
                            </div>
                            <div class="col-md-6">
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Fax Received')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <select name="fax_received" class="form-control chaser-field form-type" id="" disabled>
                                    <option value="">Select</option>
                                    <option value="Yes" {{ $lead->chaser_details ? ($lead->chaser_details->fax_received == 'Yes' ? 'selected' : '') : '' }}>Yes</option>
                                    <option value="No" {{ $lead->chaser_details ? ($lead->chaser_details->fax_received == 'No' ? 'selected' : '') : '' }}>No</option>
                                </select>
                            </div>
                            </div>
                            </div>
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Follow ups')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            @php
                                $followups = $lead->followup_details ? $lead->followup_details : []; 
                            @endphp
                            @foreach($followups as $item)   
                            <span class="badge badge-soft-danger m-2">
                                <span class="legend-indicator bg-warning"></span>Follow up date : {{$item->created_at->format('m-d-Y H:i A')}}<br>Follow up remarks : {{$item->remarks}}
                            </span> 
                            <br>
                            @endforeach
                            </form>                    
                ...
                <div class="card mt-3">
                    <!-- Header -->
                    <div class="card-header">
                        <h4 class="card-header-title">{{\App\CPU\translate('Confirmation Feedback')}}</h4>
                    </div>
                    <!-- End Header -->
                    ...
                    <form id="confirmation">
                        ...
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Action')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                                <select name="action" class="form-control confirmation-field form-type" id="" required>
                                    <option value="">Select</option>
                            ...
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Remarks')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                               <textarea name="remarks" class="form-control confirmation-field" rows="3" placeholder="Please Type your remarks" required>{{ $lead->confirmation_details ? $lead->confirmation_details->remarks : '' }}</textarea>
                            </div>
                            <hr>
...
@push('script_2')
   <script>
    ...
    $(document).ready(function() {
        $('.form-filling-field').attr('disabled',true);
        $('.form-type').on('change', function(){
            $('.commercial').toggleClass('d-none', $(this).val() !== 'Universal');
        });
        ...
        $(document).on('submit','#confirmation',function(e){
            ...
            $('.invalid-feedback.is-invalid').remove();
            $.ajax({
                url : "{{route('admin.confirmation.store')}}",
                type : "POST",
                data : new FormData(this),
                dataType : "json",
                contentType : false,
                ...
                success:function(response){
                    ...
                    $('.confirmation-field').attr('disabled',true);
                },
                error:function(xhr){
                    erroralert(xhr);
                    $('.submit-btn').attr('disabled',false);
