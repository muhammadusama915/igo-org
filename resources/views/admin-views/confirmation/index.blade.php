...
@section('content') 
    <div class="content container-fluid">
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{\App\CPU\translate('Confirmation')}}</li>
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="flex-between justify-content-between align-items-center flex-grow-1">
                    ...
                    <div>
                        <label> {{\App\CPU\translate('Pending for Confirmation')}} : </label>
                        ...
                        <tr class="lead-{{$lead->id}} class-all {{ $lead->status == '1' ? 'submitted' : 'rejected'}}">
                            <td>
                                <div class="dropdown">
                                    ...
                                    @if(\App\CPU\Helpers::module_permission_check('view_confirmation'))   
                                        <a class="dropdown-item"
                                            href="{{route('admin.confirmation.view',$lead->id)}}"><i
                                        ...
                                        @endif
                                        @if(\App\CPU\Helpers::module_permission_check('edit_confirmation') && ($lead->status == 11 || $lead->status == 13)) 
                                            <a class="dropdown-item"
                                            href="{{route('admin.confirmation.edit',$lead->id)}}"><i
                                        ...
                                        @endif
                                        <a class="dropdown-item"
                                            href="{{route('admin.form_filling.view_form',$lead->id)}}" target="_blank"><i
                                                    class="tio-file"></i> {{\App\CPU\translate('View Froms')}}</a>
                                    </div>
                                </div>
                            </td>
                            <td>
