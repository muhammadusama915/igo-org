                ...
                <div class="card d-none mt-4">
                    ...
                    <form id="qa2-form">
                        ...
                        <div class="card-body">
                            ...
                            <audio controls>
                                @php
                                    $recording = isset($lead->qa2_details) ? $lead->qa2_details->initial_recording : '';
                                @endphp
                                <source src="{{ asset('storage/app/public/qa2/'.$recording) }}" type="audio/mpeg">
                                Your browser does not support the audio element.
                            </audio>
                            </div>
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Remarks')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                               <textarea name="remarks" class="form-control eligibility-field qa1-field" rows="3" placeholder="Please Type your remarks" disabled>{{ $lead->qa2_details ? $lead->qa2_details->remarks : 'Not Specified' }}</textarea>
                            </div>
                            </form>                    
                        </div>
                <!-- End Body -->
                ...
                <div class="card mt-4">
                    ...
                    <form id="form-filling">
                        ...
                        <input type="hidden" class="form-control" name="agent_id" id="formLabel"
                            ...
                            value="{{auth('admin')->id()}}">
                        <div class="card-body">
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Assigned To')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <p style="border-bottom:1px solid black;width:100%">{{ $lead->form_filling_details ? ($lead->form_filling_details->assigned_to ? $lead->form_filling_details->assigned_to->name : 'Not Specified') : 'Not Specified' }}</p>
                            </div>
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Form Type')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <p style="border-bottom:1px solid black;width:100%">{{ $lead->form_filling_details ? $lead->form_filling_details->type : 'Not Specified' }}</p>
                            </div>
                            ...
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Remarks')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                               <textarea name="remarks" class="form-control form-filling-field" rows="3" placeholder="Please Type your remarks" disabled>{{ $lead->form_filling_details ? $lead->form_filling_details->remarks : '' }}</textarea>
                            </div>
                            </form>                    
                        </div>
                <!-- End Body -->
                ...
                <div class="card mt-4">
                    ...
                    <form id="form-filling">
                        ...
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Fax Sent')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <p style="border-bottom:1px solid black;width:100%">{{ $lead->chaser_details ? $lead->chaser_details->fax_sent: 'No' }}</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Fax Received')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <p style="border-bottom:1px solid black;width:100%">{{ $lead->chaser_details ? $lead->chaser_details->fax_received: 'No' }}</p>
                            </div>
                        </div>
                        </div>
                ...
                <div class="card mt-4">
                    ...
                    <form id="form-filling">
                        ...
                        <input type="hidden" class="form-control" name="agent_id" id="formLabel"
                            ...
                            value="{{auth('admin')->id()}}">
                        <div class="card-body">
                        <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Action Sent')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                            <p style="border-bottom:1px solid black;width:100%">@if($lead->status == 13) Approved @elseif($lead->status == 14) Rejected @else Pending for Confimation @endif</p>
                            </div>
                            <label for="patient_last_visit_id" class="col-form-label input-label">{{\App\CPU\translate('Remarks')}}<i class="tio-help-outlined text-body ml-0" data-toggle="tooltip" data-placement="top" title="Display doc_zipcode"></i></label>
                            <div class="input-group input-group-sm-down-break">
                               <textarea name="remarks" class="form-control form-filling-field" rows="3" placeholder="Please Type your remarks" disabled>{{ $lead->confirmation_details ? $lead->confirmation_details->remarks : '' }}</textarea>
                            </div>
                            </form>                    
                        </div>
                <!-- End Body -->
